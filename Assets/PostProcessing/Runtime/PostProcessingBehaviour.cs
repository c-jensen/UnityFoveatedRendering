...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
		...
		RenderTexturesDrawingOrder renderTexturesDrawingOrder;
        ...
        void OnEnable()
        {
			GameObject FoveatedRendering = GameObject.Find ("2D Foveated Rendering");
			renderTexturesDrawingOrder = FoveatedRendering.GetComponent<RenderTexturesDrawingOrder>();
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            if (profile == null || m_Camera == null)
            {
				Graphics.Blit(renderTexturesDrawingOrder.finalTexture, destination);
                return;
            }
			...
			var src = renderTexturesDrawingOrder.finalTexture;
            var dst = destination;
